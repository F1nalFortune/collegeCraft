...
if(isset($_POST['sort'])){
  if($sort=='recent'){
    $sql = "SELECT review.id, review.review, review.trade_id, review.feedback, review.created, review.buyer, trade_ad.product_id, trade_ad.price, trade_ad.qty, trade_ad.seller, product.name, users.username
            FROM review
